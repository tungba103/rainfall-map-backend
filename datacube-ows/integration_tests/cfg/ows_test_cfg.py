...
style_precipitation = {
    "name": "precipitation",
    "title": "Precipitation",
    "abstract": "Visualize precipitation levels",
    "needed_bands": ["Precipitation"],
    "index_function": {
    ...
    "color_ramp": [
        {"value": 0, "color": "#ffffff", "alpha": 0},      # Vàng nhạt nhất (transparent)
        {"value": 1, "color": "#fff7bc", "alpha": 1},     # Vàng rất nhạt
        {"value": 2, "color": "#fee391", "alpha": 1},
        {"value": 3, "color": "#fec44f", "alpha": 1},
        {"value": 4, "color": "#fe9929", "alpha": 1},
        {"value": 5, "color": "#ec7014", "alpha": 1},
        {"value": 6, "color": "#cc4c02", "alpha": 1},
        {"value": 7, "color": "#993404", "alpha": 1},
        {"value": 8, "color": "#662506", "alpha": 1},
        {"value": 10, "color": "#d7301f", "alpha": 1},    # Cam đỏ nhạt
        {"value": 15, "color": "#f46d43", "alpha": 1},    # Cam nhạt
        {"value": 20, "color": "#fdae61", "alpha": 1},
        {"value": 25, "color": "#fee08b", "alpha": 1},    # Vàng cam
        {"value": 30, "color": "#d9ef8b", "alpha": 1},    # Xanh lá vàng nhạt
        {"value": 35, "color": "#a6d96a", "alpha": 1},
        {"value": 40, "color": "#66bd63", "alpha": 1},    # Xanh lá trung bình
        {"value": 45, "color": "#1a9850", "alpha": 1},    # Xanh lá đậm
        {"value": 50, "color": "#006837", "alpha": 1},    # Xanh đậm
        {"value": 100, "color": "#41b6c4", "alpha": 1},   # Xanh lam nhạt
        {"value": 250, "color": "#225ea8", "alpha": 1},   # Xanh dương đậm
        {"value": 500, "color": "#253494", "alpha": 1},   # Xanh tím đậm
        {"value": 750, "color": "#4a1486", "alpha": 1},   # Tím đậm
        {"value": 1000, "color": "#7a0177", "alpha": 1},  # Hồng tím đậm
        {"value": 5000, "color": "#ae017e", "alpha": 1},  # Đỏ hồng đậm
        {"value": 10000, "color": "#d73027", "alpha": 1}, # Đỏ cam
        {"value": 20000, "color": "#f46d43", "alpha": 1}, # Cam đậm
        {"value": 30000, "color": "#a50026", "alpha": 1}  # Đỏ đậm
    ]
    ,
    "continuous": True,
    "legend": {
...
style_precipitation = {
    ...
    "color_ramp": [
        {"value": 0, "color": "#ffffff", "alpha": 1},      # Vàng nhạt nhất (transparent)
        {"value": 1, "color": "#eef6fc"},
        {"value": 2, "color": "#e5f1fa"},
        {"value": 3, "color": "#dcebf8"},
        {"value": 4, "color": "#d3e6f5"},
        {"value": 5, "color": "#cae0f3"},
        {"value": 6, "color": "#c1dbf1"},
        {"value": 7, "color": "#b8d6ee"},
        {"value": 8, "color": "#afd0ec"},
        {"value": 9, "color": "#a6cbea"},
        {"value": 10, "color": "#9dc5e7"},
        {"value": 15, "color": "#94c0e5"},
        {"value": 20, "color": "#8bbbe3"},
        {"value": 25, "color": "#82b6e0"},
        {"value": 30, "color": "#79b0de"},
        {"value": 35, "color": "#70abdb"},
        {"value": 40, "color": "#67a6d9"},
        {"value": 45, "color": "#5ea1d7"},
        {"value": 50, "color": "#559cd4"},
        {"value": 100, "color": "#4c97d2"},
        {"value": 250, "color": "#4382c6"},
        {"value": 500, "color": "#3a6cb9"},
        {"value": 1000, "color": "#3257ad"},
        {"value": 5000, "color": "#2941a0"},
        {"value": 10000, "color": "#203b8f"},
        {"value": 20000, "color": "#17357e"},
        {"value": 30000, "color": "#0e2f6d"}
    ],
    "legend": {
        "begin": 0,
        "end": 30000,
    ...
    # "resampling": {
    #     "default": "bilinear",   # Smooths data for zoomed-in levels
    #     "overview": "bilinear",   # Keeps sharper edges at zoomed-out levels
    #     "early_resampling": "bilinear"  # Optional if your version supports this setting
    # }
...
reslim_standard = {
    "wms": {
        "max_width": 512,  # Maximum width of the WMS tile in pixels
        "max_height": 512,  # Maximum height of the WMS tile in pixels
        "zoomed_out_fill_colour": [150, 180, 200, 160],  # Fill color for low-zoom areas
        "min_zoom_factor": 10.0,  # Minimum zoom factor before showing full-resolution data
    },
    "wcs": {
        "max_datasets": 16,  # Max number of datasets that can be returned in a single WCS request
    },
}
...
ows_cfg = {
    ...
    "layers": [
        ...
        #             "multi_product": True,
        #             "abstract": """Sentinel-2 Multispectral Instrument - Nadir BRDF Adjusted Reflectance + Terrain Illumination Correction (Sentinel-2 MSI) Latest imagery mosaic with no time dimension.
        #             """,
        #             "mosaic_date_func": {
        ...
        # },
        {
            "title": "IMERG Early Daily Precipitation",
            "name": "imerg_e_10KM_daily",
            "abstract": "Daily precipitation data from IMERG Early at 10KM resolution",
            "product_name": "imerg_e_10KM_daily",
            "bands": bands_imerg,
            ...
            "styling": {
                ...
                "styles": [style_precipitation],
            },
        },
        {
            "title": "IMERG Late Daily Precipitation",
            "name": "imerg_l_10KM_daily",
            "abstract": "Daily precipitation data from IMERG Late at 10KM resolution",
            "product_name": "imerg_l_10KM_daily",
            "bands": bands_imerg,
            "resource_limits": reslim_standard,
            "dynamic": False,
            "native_crs": "EPSG:4326",
        ...
        {
            "title": "IMERG Final Daily Precipitation",
            "name": "imerg_f_10KM_daily",
            "abstract": "Daily precipitation data from IMERG Final at 10KM resolution",
            "product_name": "imerg_f_10KM_daily",
            "bands": bands_imerg,
            "resource_limits": reslim_standard,
            "dynamic": False,
            "native_crs": "EPSG:4326",
